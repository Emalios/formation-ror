...
ActiveRecord::Schema[7.0].define(version: 2022_10_27_152752) do
  ...
  create_table "recipes", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
